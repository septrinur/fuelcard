                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="m-r-10">
                                            <img src="<?=base_url();?>assets/images/users/d1.jpg" alt="user" class="rounded-circle" width="45">
                                        </div>
                                        <div class="">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="m-r-10">
                                            <img src="<?=base_url();?>assets/images/users/d2.jpg" alt="user" class="rounded-circle" width="45">
                                        </div>
                                        <div class="">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="m-r-10">
                                            <img src="<?=base_url();?>assets/images/users/d3.jpg" alt="user" class="rounded-circle" width="45">
                                        </div>
                                        <div class="">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="m-r-10">
                                            <img src="<?=base_url();?>assets/images/users/2.jpg" alt="user" class="rounded-circle" width="45">
                                        </div>
                                        <div class="">
                    ...
                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                        <li class="list-group-item todo-item" data-role="task">
                            ...
                            <ul class="list-style-none assignedto">
                                <li class="assignee">
                                    <img class="assignee-img" src="<?=base_url();?>assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title=""
                                        data-original-title="Steave">
                                </li>
                                <li class="assignee">
                                    <img class="assignee-img" src="<?=base_url();?>assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title=""
                                        data-original-title="Jessica">
                                </li>
                                <li class="assignee">
                                    <img class="assignee-img" src="<?=base_url();?>assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title=""
                                        data-original-title="Priyanka">
                                </li>
                                <li class="assignee">
                                    <img class="assignee-img" src="<?=base_url();?>assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title=""
                    ...
                    <div class="card-body">
                        ...
                        <div class="image-box m-t-30 m-b-30">
                            <a href="#" class="m-r-10" data-toggle="tooltip" data-placement="top" title="" data-original-title="Simmons">
                                <img src="<?=base_url();?>assets/images/users/1.jpg" class="rounded-circle" width="45" alt="user">
                            </a>
                            <a href="#" class="m-r-10" data-toggle="tooltip" data-placement="top" title="" data-original-title="Fitz">
                                <img src="<?=base_url();?>assets/images/users/2.jpg" class="rounded-circle" width="45" alt="user">
                            </a>
                            <a href="#" class="m-r-10" data-toggle="tooltip" data-placement="top" title="" data-original-title="Phil">
                                <img src="<?=base_url();?>assets/images/users/3.jpg" class="rounded-circle" width="45" alt="user">
                            </a>
                            <a href="#" class="m-r-10" data-toggle="tooltip" data-placement="top" title="" data-original-title="Melinda">
                                <img src="<?=base_url();?>assets/images/users/4.jpg" class="rounded-circle" width="45" alt="user">
                            </a>
                        </div>
            ...
            <div class="border-top scrollable" style="height:365px;">
                <table class="table v-middle no-border">
                    <tbody>
                        <tr>
                            <td style="width:40px">
                                <img src="<?=base_url();?>assets/images/users/1.jpg" width="50" class="rounded-circle" alt="logo">
                            </td>
                            <td>Andrew Simon</td>
                            <td align="right">
                        ...
                        <tr>
                            <td>
                                <img src="<?=base_url();?>assets/images/users/2.jpg" width="50" class="rounded-circle" alt="logo">
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="<?=base_url();?>assets/images/users/3.jpg" width="50" class="rounded-circle" alt="logo">
                            </td>
                            <td>Dany John</td>
                            <td align="right">
                        ...
                        <tr>
                            <td>
                                <img src="<?=base_url();?>assets/images/users/4.jpg" width="50" class="rounded-circle" alt="logo">
                            </td>
                            <td>Chris gyle</td>
                            <td align="right">
                        ...
                        <tr>
                            <td>
                                <img src="<?=base_url();?>assets/images/users/5.jpg" width="50" class="rounded-circle" alt="logo">
                            </td>
                            <td>Opera mini</td>
                            <td align="right">
                        ...
                        <tr>
                            <td>
                                <img src="<?=base_url();?>assets/images/users/6.jpg" width="50" class="rounded-circle" alt="logo">
                            </td>
