<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Edit Data QR</h4>
                <h6 class="card-subtitle">Form untuk melakukan perubahan data QR pada aplikasi FuelCard QR.</h6>
            </div>
            <hr>
                    <center><?php if (!empty($error)) { ?>
                        <div class="alert alert-danger"><?php echo $error; ?></div>
                    <?php } ?></center>
             <?=form_open(site_url('admin/update/'.$id),array('class'=>'form-horizontal needs-validation', 'novalidate'=>''));?>
             <input type="hidden" name="id_qr" value="<?=$param['id_qr']?>">
             <input type="hidden" name="no_pol" value="<?=$param['no_pol']?>">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="no_pol" name="no_pol" value="<?php echo (isset($param)) ? $param['no_pol'] : ''; ?>" disabled>
                                    <div class="invalid-feedback">
                                      Tidak boleh kosong.
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="no_kartu" name="no_kartu" value="<?php echo (isset($param)) ? $param['no_kartu'] : ''; ?>" onKeyPress="if(this.value.length==10) return false;" required>
                                    <div class="invalid-feedback">
                                      Tidak boleh kosong.
                                    </div>
                                </div>
