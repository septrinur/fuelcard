    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-subtitle">Form untuk penambahan data spbu pada aplikasi FuelCard QR.</h6>
            </div>
            <hr>
                    <center><?php if (!empty($error)) { ?>
                        <div class="alert alert-danger"><?php echo $error; ?></div>
                    <?php } ?></center>
             <?=form_open(site_url('admin/spbu_add'),array('class'=>'form-horizontal needs-validation', 'novalidate'=>''));?>
                <div class="card-body">
                    <div class="row">
