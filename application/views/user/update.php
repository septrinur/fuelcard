    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-subtitle">Form untuk melakukan perubahan data admin pada aplikasi FuelCard QR.</h6>
            </div>
            <hr>
                    <center><?php if (!empty($error)) { ?>
                        <div class="alert alert-danger"><?php echo $error; ?></div>
                    <?php } ?></center>
             <?=form_open(site_url('user/update/'.$id),array('class'=>'form-horizontal needs-validation', 'novalidate'=>''));?>
