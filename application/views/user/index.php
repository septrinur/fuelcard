			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-sm-12 col-lg-3">
						<?=form_open(site_url('user/index'),array('method'=>'get'));?>
	                        <div class="input-group mb-3">
	                            <input type="text" name="s" class="form-control" placeholder="Cari username, nama, no hp, email" aria-label="" aria-describedby="basic-addon1" value="<?php echo (isset($s)) ? $s : ''; ?>">
